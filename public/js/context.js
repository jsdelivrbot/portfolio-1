var context = {
  ...
  paragraphs: {
    ...
    research2:'By talking with users, we determined that there was confusion around the nature of adding candidates to Upknown. Was it an endorsement of the candidate’s skills? Or just a resume blast? What about people I don’t know but want to track anyway? We also heard indirectly that our one onboarding page was poor/nonexistant (probably didn’t need to do research to confirm that).',
    research3:'By looking at user behavior, we saw that most people didn\'t take the time to log into the app every time they forward a candidate into the system. We needed to re-think the email forwarding flow, and beef up the way that people interact with Upknown in their inboxes.',
